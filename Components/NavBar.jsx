        ...
        >
            <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
                ...
                <div className={`flex-1 items-center mt-8 md:mt-0 md:flex ${state ? "block" : "hidden"}`}>
                      <ul className="justify center items-center  md:flex md:space-x-6 md-space-y-0">
                            {navigation.map((item,index)=>{
                                return <li key={index} className="text-gray-700 hover:text-gray-900">
                      ...
                      <div className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
                            {currentUser ? (
                              ...
                              <button onClick={() => connectWallet()} className="flex items-center justify-center gap-x-2 px-2 py-2 text-white font-medium bg-gray-800 hover:bg-gray-700 active:bg-gray-900 rounded-full md:inline-flex">
                                  Connect Wallet
                                  <Nav3/>
                              </button>
                            )}
