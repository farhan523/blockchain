...
contract Tracking {
    ...
    function createShipment(address _receiver, uint256 _pickupTime, uint256 _distnce, uint256 _price) public payable {
            require(msg.value  == _price, "Payment amount must match the price.");

            Shipment memory shipment = Shipment(msg.sender, _receiver, _pickupTime, 0, _distnce, _price, ShipmentStatus.PENDING,false);
